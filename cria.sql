...
INSERT INTO MC_SGV_SAC (nr_sac, nr_cliente, cd_produto,  cd_funcionario, ds_detalhada_sac, dt_abertura_sac, hr_abertura_sac, dt_atendimento, hr_atendimento_sac, nr_tempo_total_sac, ds_detalhada_retorno_sac, tp_sac, st_sac, nr_indice_satisfacao )
     values( SQ_MC_SGV_SAC.nextval, 3,3,20,'Cliente reclamou que o produto não funciona', SYSDATE -1, 2,  SYSDATE, 2, null, 'Cliente reclamou que o produto não funciona', 'D', 'E', null);

INSERT INTO MC_SGV_SAC (nr_sac, nr_cliente, cd_produto,  cd_funcionario, ds_detalhada_sac, dt_abertura_sac, hr_abertura_sac, dt_atendimento, hr_atendimento_sac, nr_tempo_total_sac, ds_detalhada_retorno_sac, tp_sac, st_sac, nr_indice_satisfacao )
     values( SQ_MC_SGV_SAC.nextval, 2,2,20,'Cliente reclamou de defeito', SYSDATE -1, 20,  SYSDATE, 20, null, 'Cliente reclamou de defeito', 'D', 'E', null);

INSERT INTO MC_SGV_SAC (nr_sac, nr_cliente, cd_produto,  cd_funcionario, ds_detalhada_sac, dt_abertura_sac, hr_abertura_sac, dt_atendimento, hr_atendimento_sac, nr_tempo_total_sac, ds_detalhada_retorno_sac, tp_sac, st_sac, nr_indice_satisfacao )
     values(SQ_MC_SGV_SAC.nextval, 5,5,20,'Cliente fez elogio', SYSDATE -1, 3,  SYSDATE, 3, null, 'Cliente fez elogio', 'E', 'E', null);
